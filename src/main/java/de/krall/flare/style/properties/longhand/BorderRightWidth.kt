...
class BorderRightWidthId : LonghandId() {
    ...
    override fun parseValue(context: ParserContext, input: Parser): Result<PropertyDeclaration, ParseError> {
        return NonNegativeLength.parse(context, input).map { width -> BorderRightWidthDeclaration(width) }
    }
...
class BorderRightWidthDeclaration(val width: NonNegativeLength) : PropertyDeclaration() {
