...
sealed class SingleFontFamily {
    ...
    companion object Contract {
        ...
        fun parse(input: Parser): Result<SingleFontFamily, ParseError> {
            ...
            if (stringResult is Ok) {
                return Ok(SingleFontFamily.FamilyName(de.krall.flare.css.value.computed.FamilyName(
                        stringResult.value
                )))
            }
    ...
    class FamilyName(val name: de.krall.flare.css.value.computed.FamilyName) : SingleFontFamily()
